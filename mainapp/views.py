...
from mainapp.forms import EmailPostForm
from mainapp.models import Product, Category, EmailPost
...
class EmailCreateView(CreateView):
    template_name = 'mainapp/email_form.html'
    form_class = EmailPostForm
    success_url = reverse_lazy('mainapp:email')
